    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md w-[95vw] max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Wybierz gracza z listy dostępnych, aby dodać go do wydarzenia. Tylko gracze, którzy jeszcze się nie zapisali, będą widoczni na liście.
          </DialogDescription>
        </DialogHeader>
              ...
              <SelectContent>
                {availablePlayers.length === 0 ? (
                  <div className="p-4 text-center text-sm text-muted-foreground">
                    Brak dostępnych graczy do dodania
                  </div>
                ) : (
